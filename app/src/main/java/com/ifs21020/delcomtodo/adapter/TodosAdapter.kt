package com.ifs21020.delcomtodo.adapter
...
import com.ifs21020.delcomtodo.databinding.ItemRowTodoBinding

class TodosAdapter :
    ListAdapter<TodosItemResponse, TodosAdapter.MyViewHolder>(DIFF_CALLBACK) {
